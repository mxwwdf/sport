       ...
       <div class='cards-holder'>
            ...
            <div class='card'>
                ...
                <div class='card-image'>
                    <img class='card-img' height="55" width="55" src='img_s/card.png'>
                </div>
    ...
    <div class='container'>
        ...
        <div class='history-holder'>
            ...
            <div class='history-images'>
                <img class='imgages-1' height="355" width="295" src="img_s/1.jpg" alt="">
                <img class='imgages-2' height="355" width="295" src="img_s/2.jpg" alt="">
                <img class='imgages-3'height="300" width="260" src="img_s/3.jpg" alt="">
        </div>
        </div>
    ...
    <div class='container'>
        ...
        <div class='burgers'>
            <div class='burgers-image'>
                <img src='img_s/sek.jpg' class='pizza'>
            </div>

            <div class='burgers-items'>
                <div class='burger-item'>
                    <img src="img_s/sek_mini.jpg" class=''>
        ...
        <div class='menu-items'>
            ...
            <div class='menu-item'>
                <div class='menu-image'>
                    <img src='img_s/news.jpg' class='menu-img'>
                </div>
    ...
    <div class='container'>
        ...
        <div class='galery-content'>
            ...
            <div class='galery-left'>
                ...
                <div class='galery-up'>
                    <img class='img-gal high' src="img_s/10.jpg">
                </div>

                <div class='galery-down'>
                    <img class='img-gal' src="img_s/20.jpg">
                    <img class='img-gal' src="img_s/30.jpg">
                </div>
...
<div class='cook'>
    ...
    <div class='container'>
        ...
        <div class='cook-content'>
            <img src='img_s/1c.jpg'>
            <img src='img_s/2c.jpg'>
            <img src='img_s/3c.jpg'>
        </div>
